...
///
    ...
    tcase_add_test(tc, test_from_decimal_to_int_ok101);
    tcase_add_test(tc, test_from_decimal_to_int_ok102);
    tcase_add_test(tc, test_from_decimal_to_int_ok103);
    tcase_add_test(tc, test_from_decimal_to_int_ok104);
    tcase_add_test(tc, test_from_decimal_to_int_ok105);
    tcase_add_test(tc, test_from_decimal_to_int_ok106);
    tcase_add_test(tc, test_from_decimal_to_int_ok107);
    tcase_add_test(tc, test_from_decimal_to_int_ok108);
    tcase_add_test(tc, test_from_decimal_to_int_ok109);
    tcase_add_test(tc, test_from_decimal_to_int_ok110);
    tcase_add_test(tc, test_from_decimal_to_int_ok111);
    tcase_add_test(tc, test_from_decimal_to_int_ok112);
    tcase_add_test(tc, test_from_decimal_to_int_ok113);
    tcase_add_test(tc, test_from_decimal_to_int_ok114);
    tcase_add_test(tc, test_from_decimal_to_int_ok115);
    tcase_add_test(tc, test_from_decimal_to_int_ok116);
    tcase_add_test(tc, test_from_decimal_to_int_ok117);
    tcase_add_test(tc, test_from_decimal_to_int_ok118);
    tcase_add_test(tc, test_from_decimal_to_int_ok119);
    tcase_add_test(tc, test_from_decimal_to_int_ok120);
    tcase_add_test(tc, test_from_decimal_to_int_ok121);
    tcase_add_test(tc, test_from_decimal_to_int_ok122);
    tcase_add_test(tc, test_from_decimal_to_int_ok123);
    tcase_add_test(tc, test_from_decimal_to_int_ok124);
    tcase_add_test(tc, test_from_decimal_to_int_ok125);
    tcase_add_test(tc, test_from_decimal_to_int_ok126);
    tcase_add_test(tc, test_from_decimal_to_int_ok127);
    tcase_add_test(tc, test_from_decimal_to_int_ok128);
    tcase_add_test(tc, test_from_decimal_to_int_ok129);
    tcase_add_test(tc, test_from_decimal_to_int_ok130);
    tcase_add_test(tc, test_from_decimal_to_int_ok131);
    tcase_add_test(tc, test_from_decimal_to_int_ok132);
    tcase_add_test(tc, test_from_decimal_to_int_ok133);
    tcase_add_test(tc, test_from_decimal_to_int_ok134);
    tcase_add_test(tc, test_from_decimal_to_int_ok135);
    tcase_add_test(tc, test_from_decimal_to_int_ok136);
    tcase_add_test(tc, test_from_decimal_to_int_ok137);
    tcase_add_test(tc, test_from_decimal_to_int_ok138);
    tcase_add_test(tc, test_from_decimal_to_int_ok139);
    tcase_add_test(tc, test_from_decimal_to_int_ok140);
    tcase_add_test(tc, test_from_decimal_to_int_ok141);
    tcase_add_test(tc, test_from_decimal_to_int_ok142);
    tcase_add_test(tc, test_from_decimal_to_int_ok143);
    tcase_add_test(tc, test_from_decimal_to_int_ok144);
    tcase_add_test(tc, test_from_decimal_to_int_ok145);
    tcase_add_test(tc, test_from_decimal_to_int_ok146);
    tcase_add_test(tc, test_from_decimal_to_int_ok147);
    tcase_add_test(tc, test_from_decimal_to_int_ok148);
    tcase_add_test(tc, test_from_decimal_to_int_ok149);
    tcase_add_test(tc, test_from_decimal_to_int_ok150);
    tcase_add_test(tc, test_from_decimal_to_int_ok151);
    tcase_add_test(tc, test_from_decimal_to_int_ok152);
    tcase_add_test(tc, test_from_decimal_to_int_ok153);
    tcase_add_test(tc, test_from_decimal_to_int_ok154);
    tcase_add_test(tc, test_from_decimal_to_int_ok155);
    tcase_add_test(tc, test_from_decimal_to_int_ok156);
    tcase_add_test(tc, test_from_decimal_to_int_ok157);
    tcase_add_test(tc, test_from_decimal_to_int_ok158);
    tcase_add_test(tc, test_from_decimal_to_int_ok159);
    tcase_add_test(tc, test_from_decimal_to_int_ok160);
    tcase_add_test(tc, test_from_decimal_to_int_ok161);
    tcase_add_test(tc, test_from_decimal_to_int_ok162);
    tcase_add_test(tc, test_from_decimal_to_int_ok163);
    tcase_add_test(tc, test_from_decimal_to_int_ok164);
    tcase_add_test(tc, test_from_decimal_to_int_ok165);
    tcase_add_test(tc, test_from_decimal_to_int_ok166);
    tcase_add_test(tc, test_from_decimal_to_int_ok167);
    tcase_add_test(tc, test_from_decimal_to_int_ok168);
    tcase_add_test(tc, test_from_decimal_to_int_ok169);
    tcase_add_test(tc, test_from_decimal_to_int_ok170);
    tcase_add_test(tc, test_from_decimal_to_int_ok171);
    tcase_add_test(tc, test_from_decimal_to_int_ok172);
    tcase_add_test(tc, test_from_decimal_to_int_ok173);
    tcase_add_test(tc, test_from_decimal_to_int_ok174);
    tcase_add_test(tc, test_from_decimal_to_int_ok175);
    tcase_add_test(tc, test_from_decimal_to_int_ok176);
    tcase_add_test(tc, test_from_decimal_to_int_ok177);
    tcase_add_test(tc, test_from_decimal_to_int_ok178);
    tcase_add_test(tc, test_from_decimal_to_int_ok179);
    tcase_add_test(tc, test_from_decimal_to_int_ok180);
    tcase_add_test(tc, test_from_decimal_to_int_ok181);
    tcase_add_test(tc, test_from_decimal_to_int_ok182);
    tcase_add_test(tc, test_from_decimal_to_int_ok183);
    tcase_add_test(tc, test_from_decimal_to_int_ok184);
    tcase_add_test(tc, test_from_decimal_to_int_ok185);
    tcase_add_test(tc, test_from_decimal_to_int_ok186);
    tcase_add_test(tc, test_from_decimal_to_int_ok187);
    tcase_add_test(tc, test_from_decimal_to_int_ok188);
    tcase_add_test(tc, test_from_decimal_to_int_ok189);
    tcase_add_test(tc, test_from_decimal_to_int_ok190);
    tcase_add_test(tc, test_from_decimal_to_int_ok191);
    tcase_add_test(tc, test_from_decimal_to_int_ok192);
    tcase_add_test(tc, test_from_decimal_to_int_ok193);
    tcase_add_test(tc, test_from_decimal_to_int_ok194);
    tcase_add_test(tc, test_from_decimal_to_int_ok195);
    tcase_add_test(tc, test_from_decimal_to_int_ok196);
    tcase_add_test(tc, test_from_decimal_to_int_ok197);
    tcase_add_test(tc, test_from_decimal_to_int_ok198);
    tcase_add_test(tc, test_from_decimal_to_int_ok199);
    tcase_add_test(tc, test_from_decimal_to_int_ok200);
    tcase_add_test(tc, test_from_decimal_to_int_ok201);
    tcase_add_test(tc, test_from_decimal_to_int_ok202);
    tcase_add_test(tc, test_from_decimal_to_int_ok203);
    tcase_add_test(tc, test_from_decimal_to_int_ok204);
    tcase_add_test(tc, test_from_decimal_to_int_ok205);
    tcase_add_test(tc, test_from_decimal_to_int_ok206);
    tcase_add_test(tc, test_from_decimal_to_int_ok207);
    tcase_add_test(tc, test_from_decimal_to_int_ok208);
    tcase_add_test(tc, test_from_decimal_to_int_ok209);
    tcase_add_test(tc, test_from_decimal_to_int_ok210);
    tcase_add_test(tc, test_from_decimal_to_int_ok211);
    tcase_add_test(tc, test_from_decimal_to_int_ok212);
    tcase_add_test(tc, test_from_decimal_to_int_ok213);
    tcase_add_test(tc, test_from_decimal_to_int_ok214);
    tcase_add_test(tc, test_from_decimal_to_int_ok215);
    tcase_add_test(tc, test_from_decimal_to_int_ok216);
    tcase_add_test(tc, test_from_decimal_to_int_ok217);
    tcase_add_test(tc, test_from_decimal_to_int_ok218);
    tcase_add_test(tc, test_from_decimal_to_int_ok219);
    tcase_add_test(tc, test_from_decimal_to_int_ok220);
    tcase_add_test(tc, test_from_decimal_to_int_ok221);
    tcase_add_test(tc, test_from_decimal_to_int_ok222);
    tcase_add_test(tc, test_from_decimal_to_int_ok223);
    tcase_add_test(tc, test_from_decimal_to_int_ok224);
    tcase_add_test(tc, test_from_decimal_to_int_ok225);
    tcase_add_test(tc, test_from_decimal_to_int_ok226);
    tcase_add_test(tc, test_from_decimal_to_int_ok227);
    tcase_add_test(tc, test_from_decimal_to_int_ok228);
    tcase_add_test(tc, test_from_decimal_to_int_ok229);
    tcase_add_test(tc, test_from_decimal_to_int_ok230);
    tcase_add_test(tc, test_from_decimal_to_int_ok231);
    tcase_add_test(tc, test_from_decimal_to_int_ok232);
    tcase_add_test(tc, test_from_decimal_to_int_ok233);
    tcase_add_test(tc, test_from_decimal_to_int_ok234);
    tcase_add_test(tc, test_from_decimal_to_int_ok235);
    tcase_add_test(tc, test_from_decimal_to_int_ok236);
    tcase_add_test(tc, test_from_decimal_to_int_ok237);
    tcase_add_test(tc, test_from_decimal_to_int_ok238);
    tcase_add_test(tc, test_from_decimal_to_int_ok239);
    tcase_add_test(tc, test_from_decimal_to_int_ok240);
    tcase_add_test(tc, test_from_decimal_to_int_ok241);
    tcase_add_test(tc, test_from_decimal_to_int_ok242);
    tcase_add_test(tc, test_from_decimal_to_int_ok243);
    tcase_add_test(tc, test_from_decimal_to_int_ok244);
    tcase_add_test(tc, test_from_decimal_to_int_ok245);
    tcase_add_test(tc, test_from_decimal_to_int_ok246);
    tcase_add_test(tc, test_from_decimal_to_int_ok247);
    tcase_add_test(tc, test_from_decimal_to_int_ok248);
    tcase_add_test(tc, test_from_decimal_to_int_ok249);
    tcase_add_test(tc, test_from_decimal_to_int_ok250);
    tcase_add_test(tc, test_from_decimal_to_int_ok251);
    tcase_add_test(tc, test_from_decimal_to_int_ok252);
    tcase_add_test(tc, test_from_decimal_to_int_ok253);
    tcase_add_test(tc, test_from_decimal_to_int_ok254);
    tcase_add_test(tc, test_from_decimal_to_int_ok255);
    tcase_add_test(tc, test_from_decimal_to_int_ok256);
    tcase_add_test(tc, test_from_decimal_to_int_ok257);
    tcase_add_test(tc, test_from_decimal_to_int_ok258);
    tcase_add_test(tc, test_from_decimal_to_int_ok259);
    tcase_add_test(tc, test_from_decimal_to_int_ok260);
    tcase_add_test(tc, test_from_decimal_to_int_ok261);
    tcase_add_test(tc, test_from_decimal_to_int_ok262);
    tcase_add_test(tc, test_from_decimal_to_int_ok263);
    tcase_add_test(tc, test_from_decimal_to_int_ok264);
    tcase_add_test(tc, test_from_decimal_to_int_ok265);
    tcase_add_test(tc, test_from_decimal_to_int_ok266);
    tcase_add_test(tc, test_from_decimal_to_int_ok267);
    tcase_add_test(tc, test_from_decimal_to_int_ok268);
    tcase_add_test(tc, test_from_decimal_to_int_ok269);
    tcase_add_test(tc, test_from_decimal_to_int_ok270);
    tcase_add_test(tc, test_from_decimal_to_int_ok271);
    tcase_add_test(tc, test_from_decimal_to_int_ok272);
    tcase_add_test(tc, test_from_decimal_to_int_ok273);
    tcase_add_test(tc, test_from_decimal_to_int_ok274);
    tcase_add_test(tc, test_from_decimal_to_int_ok275);
    tcase_add_test(tc, test_from_decimal_to_int_ok276);
    tcase_add_test(tc, test_from_decimal_to_int_ok277);
    tcase_add_test(tc, test_from_decimal_to_int_ok278);
    tcase_add_test(tc, test_from_decimal_to_int_ok279);
    tcase_add_test(tc, test_from_decimal_to_int_ok280);
    tcase_add_test(tc, test_from_decimal_to_int_ok281);
    tcase_add_test(tc, test_from_decimal_to_int_ok282);
    tcase_add_test(tc, test_from_decimal_to_int_ok283);
    tcase_add_test(tc, test_from_decimal_to_int_ok284);
    tcase_add_test(tc, test_from_decimal_to_int_ok285);
    tcase_add_test(tc, test_from_decimal_to_int_ok286);
    tcase_add_test(tc, test_from_decimal_to_int_ok287);
    tcase_add_test(tc, test_from_decimal_to_int_ok288);
    tcase_add_test(tc, test_from_decimal_to_int_ok289);
    tcase_add_test(tc, test_from_decimal_to_int_ok290);
    tcase_add_test(tc, test_from_decimal_to_int_ok291);
    tcase_add_test(tc, test_from_decimal_to_int_ok292);
    tcase_add_test(tc, test_from_decimal_to_int_ok293);
    tcase_add_test(tc, test_from_decimal_to_int_ok294);
    tcase_add_test(tc, test_from_decimal_to_int_ok295);
    tcase_add_test(tc, test_from_decimal_to_int_ok296);
    tcase_add_test(tc, test_from_decimal_to_int_ok297);
    tcase_add_test(tc, test_from_decimal_to_int_ok298);
    tcase_add_test(tc, test_from_decimal_to_int_ok299);
    tcase_add_test(tc, test_from_decimal_to_int_ok300);
    tcase_add_test(tc, test_from_decimal_to_int_ok301);
    tcase_add_test(tc, test_from_decimal_to_int_ok302);
    tcase_add_test(tc, test_from_decimal_to_int_ok303);
    tcase_add_test(tc, test_from_decimal_to_int_ok304);
    tcase_add_test(tc, test_from_decimal_to_int_ok305);
    tcase_add_test(tc, test_from_decimal_to_int_ok306);
    tcase_add_test(tc, test_from_decimal_to_int_ok307);
    tcase_add_test(tc, test_from_decimal_to_int_ok308);
    tcase_add_test(tc, test_from_decimal_to_int_ok309);
    tcase_add_test(tc, test_from_decimal_to_int_ok310);
    tcase_add_test(tc, test_from_decimal_to_int_ok311);
    tcase_add_test(tc, test_from_decimal_to_int_ok312);
    tcase_add_test(tc, test_from_decimal_to_int_ok313);
    tcase_add_test(tc, test_from_decimal_to_int_ok314);
    tcase_add_test(tc, test_from_decimal_to_int_ok315);
    tcase_add_test(tc, test_from_decimal_to_int_ok316);
    tcase_add_test(tc, test_from_decimal_to_int_ok317);
    tcase_add_test(tc, test_from_decimal_to_int_ok318);
    tcase_add_test(tc, test_from_decimal_to_int_ok319);
    tcase_add_test(tc, test_from_decimal_to_int_ok320);
    tcase_add_test(tc, test_from_decimal_to_int_ok321);
    tcase_add_test(tc, test_from_decimal_to_int_ok322);
    tcase_add_test(tc, test_from_decimal_to_int_ok323);
    tcase_add_test(tc, test_from_decimal_to_int_ok324);
    tcase_add_test(tc, test_from_decimal_to_int_ok325);
    tcase_add_test(tc, test_from_decimal_to_int_ok326);
    tcase_add_test(tc, test_from_decimal_to_int_ok327);
    tcase_add_test(tc, test_from_decimal_to_int_ok328);
    tcase_add_test(tc, test_from_decimal_to_int_ok329);
    tcase_add_test(tc, test_from_decimal_to_int_ok330);
    tcase_add_test(tc, test_from_decimal_to_int_ok331);
    tcase_add_test(tc, test_from_decimal_to_int_ok332);
    tcase_add_test(tc, test_from_decimal_to_int_ok333);
    tcase_add_test(tc, test_from_decimal_to_int_ok334);
    tcase_add_test(tc, test_from_decimal_to_int_ok335);
    tcase_add_test(tc, test_from_decimal_to_int_ok336);
    tcase_add_test(tc, test_from_decimal_to_int_ok337);
    tcase_add_test(tc, test_from_decimal_to_int_ok338);
    tcase_add_test(tc, test_from_decimal_to_int_ok339);
    tcase_add_test(tc, test_from_decimal_to_int_ok340);
    tcase_add_test(tc, test_from_decimal_to_int_ok341);
    tcase_add_test(tc, test_from_decimal_to_int_ok342);
    tcase_add_test(tc, test_from_decimal_to_int_ok343);
    tcase_add_test(tc, test_from_decimal_to_int_ok344);
    tcase_add_test(tc, test_from_decimal_to_int_ok345);
    tcase_add_test(tc, test_from_decimal_to_int_ok346);
    tcase_add_test(tc, test_from_decimal_to_int_ok347);
    tcase_add_test(tc, test_from_decimal_to_int_ok348);
    tcase_add_test(tc, test_from_decimal_to_int_ok349);
    tcase_add_test(tc, test_from_decimal_to_int_ok350);
    tcase_add_test(tc, test_from_decimal_to_int_ok351);
    tcase_add_test(tc, test_from_decimal_to_int_ok352);
    tcase_add_test(tc, test_from_decimal_to_int_ok353);
    tcase_add_test(tc, test_from_decimal_to_int_ok354);
    tcase_add_test(tc, test_from_decimal_to_int_ok355);
    tcase_add_test(tc, test_from_decimal_to_int_ok356);
    tcase_add_test(tc, test_from_decimal_to_int_ok357);
    tcase_add_test(tc, test_from_decimal_to_int_ok358);
    tcase_add_test(tc, test_from_decimal_to_int_ok359);
    tcase_add_test(tc, test_from_decimal_to_int_ok360);
    tcase_add_test(tc, test_from_decimal_to_int_ok361);
    tcase_add_test(tc, test_from_decimal_to_int_ok362);
    tcase_add_test(tc, test_from_decimal_to_int_ok363);
    tcase_add_test(tc, test_from_decimal_to_int_ok364);
    tcase_add_test(tc, test_from_decimal_to_int_ok365);
    tcase_add_test(tc, test_from_decimal_to_int_ok366);
    tcase_add_test(tc, test_from_decimal_to_int_ok367);
    tcase_add_test(tc, test_from_decimal_to_int_ok368);
    tcase_add_test(tc, test_from_decimal_to_int_ok369);
    tcase_add_test(tc, test_from_decimal_to_int_ok370);
    tcase_add_test(tc, test_from_decimal_to_int_ok371);
    tcase_add_test(tc, test_from_decimal_to_int_ok372);
    tcase_add_test(tc, test_from_decimal_to_int_ok373);
    tcase_add_test(tc, test_from_decimal_to_int_ok374);
    tcase_add_test(tc, test_from_decimal_to_int_ok375);
    tcase_add_test(tc, test_from_decimal_to_int_ok376);
    tcase_add_test(tc, test_from_decimal_to_int_ok377);
    tcase_add_test(tc, test_from_decimal_to_int_ok378);
    tcase_add_test(tc, test_from_decimal_to_int_ok379);
    tcase_add_test(tc, test_from_decimal_to_int_ok380);
    tcase_add_test(tc, test_from_decimal_to_int_ok381);
    tcase_add_test(tc, test_from_decimal_to_int_ok382);
    tcase_add_test(tc, test_from_decimal_to_int_ok383);
    tcase_add_test(tc, test_from_decimal_to_int_ok384);
    tcase_add_test(tc, test_from_decimal_to_int_ok385);
    tcase_add_test(tc, test_from_decimal_to_int_ok386);
    tcase_add_test(tc, test_from_decimal_to_int_ok387);
    tcase_add_test(tc, test_from_decimal_to_int_ok388);
    tcase_add_test(tc, test_from_decimal_to_int_ok389);
    tcase_add_test(tc, test_from_decimal_to_int_ok390);
    tcase_add_test(tc, test_from_decimal_to_int_ok391);
    tcase_add_test(tc, test_from_decimal_to_int_ok392);
    tcase_add_test(tc, test_from_decimal_to_int_ok393);
    tcase_add_test(tc, test_from_decimal_to_int_ok394);
    tcase_add_test(tc, test_from_decimal_to_int_ok395);
    tcase_add_test(tc, test_from_decimal_to_int_ok396);
    tcase_add_test(tc, test_from_decimal_to_int_ok397);
    tcase_add_test(tc, test_from_decimal_to_int_ok398);
    tcase_add_test(tc, test_from_decimal_to_int_ok399);
    tcase_add_test(tc, test_from_decimal_to_int_ok400);
////

    tcase_add_test(tc, test_from_decimal_to_int_ok401);
    tcase_add_test(tc, test_from_decimal_to_int_ok402);
    tcase_add_test(tc, test_from_decimal_to_int_ok403);
    tcase_add_test(tc, test_from_decimal_to_int_ok404);
    tcase_add_test(tc, test_from_decimal_to_int_ok405);
    tcase_add_test(tc, test_from_decimal_to_int_ok406);
    tcase_add_test(tc, test_from_decimal_to_int_ok407);
    tcase_add_test(tc, test_from_decimal_to_int_ok408);
    tcase_add_test(tc, test_from_decimal_to_int_ok409);
    tcase_add_test(tc, test_from_decimal_to_int_ok410);
    tcase_add_test(tc, test_from_decimal_to_int_ok411);
    tcase_add_test(tc, test_from_decimal_to_int_ok412);
    tcase_add_test(tc, test_from_decimal_to_int_ok413);
    tcase_add_test(tc, test_from_decimal_to_int_ok414);
    tcase_add_test(tc, test_from_decimal_to_int_ok415);
    tcase_add_test(tc, test_from_decimal_to_int_ok416);
    tcase_add_test(tc, test_from_decimal_to_int_ok417);
    tcase_add_test(tc, test_from_decimal_to_int_ok418);
    tcase_add_test(tc, test_from_decimal_to_int_ok419);
    tcase_add_test(tc, test_from_decimal_to_int_ok420);
    tcase_add_test(tc, test_from_decimal_to_int_ok421);
    tcase_add_test(tc, test_from_decimal_to_int_ok422);
    tcase_add_test(tc, test_from_decimal_to_int_ok423);
    tcase_add_test(tc, test_from_decimal_to_int_ok424);
    tcase_add_test(tc, test_from_decimal_to_int_ok425);
    tcase_add_test(tc, test_from_decimal_to_int_ok426);
    tcase_add_test(tc, test_from_decimal_to_int_ok427);
    tcase_add_test(tc, test_from_decimal_to_int_ok428);
    tcase_add_test(tc, test_from_decimal_to_int_ok429);
    tcase_add_test(tc, test_from_decimal_to_int_ok430);
    tcase_add_test(tc, test_from_decimal_to_int_ok431);
    tcase_add_test(tc, test_from_decimal_to_int_ok432);
    tcase_add_test(tc, test_from_decimal_to_int_ok433);
    tcase_add_test(tc, test_from_decimal_to_int_ok434);
    tcase_add_test(tc, test_from_decimal_to_int_ok435);
    tcase_add_test(tc, test_from_decimal_to_int_ok436);
    tcase_add_test(tc, test_from_decimal_to_int_ok437);
    tcase_add_test(tc, test_from_decimal_to_int_ok438);
    tcase_add_test(tc, test_from_decimal_to_int_ok439);
    tcase_add_test(tc, test_from_decimal_to_int_ok440);
    tcase_add_test(tc, test_from_decimal_to_int_ok441);
    tcase_add_test(tc, test_from_decimal_to_int_ok442);
    tcase_add_test(tc, test_from_decimal_to_int_ok443);
    tcase_add_test(tc, test_from_decimal_to_int_ok444);
    tcase_add_test(tc, test_from_decimal_to_int_ok445);
    tcase_add_test(tc, test_from_decimal_to_int_ok446);
    tcase_add_test(tc, test_from_decimal_to_int_ok447);
    tcase_add_test(tc, test_from_decimal_to_int_ok448);
    tcase_add_test(tc, test_from_decimal_to_int_ok449);
    tcase_add_test(tc, test_from_decimal_to_int_ok450);
    tcase_add_test(tc, test_from_decimal_to_int_ok451);
    tcase_add_test(tc, test_from_decimal_to_int_ok452);
    tcase_add_test(tc, test_from_decimal_to_int_ok453);
    tcase_add_test(tc, test_from_decimal_to_int_ok454);
    tcase_add_test(tc, test_from_decimal_to_int_ok455);
    tcase_add_test(tc, test_from_decimal_to_int_ok456);
    tcase_add_test(tc, test_from_decimal_to_int_ok457);
    tcase_add_test(tc, test_from_decimal_to_int_ok458);
    tcase_add_test(tc, test_from_decimal_to_int_ok459);
///
    ...
    tcase_add_test(tc, test_from_decimal_to_int_fail46);
    tcase_add_test(tc, test_from_decimal_to_int_fail47);
    tcase_add_test(tc, test_from_decimal_to_int_fail48);
    tcase_add_test(tc, test_from_decimal_to_int_fail49);
    tcase_add_test(tc, test_from_decimal_to_int_fail50);
    tcase_add_test(tc, test_from_decimal_to_int_fail51);
    tcase_add_test(tc, test_from_decimal_to_int_fail52);
    tcase_add_test(tc, test_from_decimal_to_int_fail53);
    tcase_add_test(tc, test_from_decimal_to_int_fail54);
    tcase_add_test(tc, test_from_decimal_to_int_fail55);
    tcase_add_test(tc, test_from_decimal_to_int_fail56);
    tcase_add_test(tc, test_from_decimal_to_int_fail57);
    tcase_add_test(tc, test_from_decimal_to_int_fail58);
    tcase_add_test(tc, test_from_decimal_to_int_fail59);
    tcase_add_test(tc, test_from_decimal_to_int_fail60);
    tcase_add_test(tc, test_from_decimal_to_int_fail61);
    tcase_add_test(tc, test_from_decimal_to_int_fail62);
    tcase_add_test(tc, test_from_decimal_to_int_fail63);
    tcase_add_test(tc, test_from_decimal_to_int_fail64);
    tcase_add_test(tc, test_from_decimal_to_int_fail65);
    tcase_add_test(tc, test_from_decimal_to_int_fail66);
    tcase_add_test(tc, test_from_decimal_to_int_fail67);
    tcase_add_test(tc, test_from_decimal_to_int_fail68);
    tcase_add_test(tc, test_from_decimal_to_int_fail69);
    tcase_add_test(tc, test_from_decimal_to_int_fail70);
    tcase_add_test(tc, test_from_decimal_to_int_fail71);
    tcase_add_test(tc, test_from_decimal_to_int_fail72);
    tcase_add_test(tc, test_from_decimal_to_int_fail73);
    tcase_add_test(tc, test_from_decimal_to_int_fail74);
    tcase_add_test(tc, test_from_decimal_to_int_fail75);
    tcase_add_test(tc, test_from_decimal_to_int_fail76);
    tcase_add_test(tc, test_from_decimal_to_int_fail77);
    tcase_add_test(tc, test_from_decimal_to_int_fail78);
    tcase_add_test(tc, test_from_decimal_to_int_fail79);
    tcase_add_test(tc, test_from_decimal_to_int_fail80);
    tcase_add_test(tc, test_from_decimal_to_int_fail81);
    tcase_add_test(tc, test_from_decimal_to_int_fail82);
    tcase_add_test(tc, test_from_decimal_to_int_fail83);
    tcase_add_test(tc, test_from_decimal_to_int_fail84);
    tcase_add_test(tc, test_from_decimal_to_int_fail85);
    tcase_add_test(tc, test_from_decimal_to_int_fail86);
    tcase_add_test(tc, test_from_decimal_to_int_fail87);
    tcase_add_test(tc, test_from_decimal_to_int_fail88);
    tcase_add_test(tc, test_from_decimal_to_int_fail89);
    tcase_add_test(tc, test_from_decimal_to_int_fail90);
    tcase_add_test(tc, test_from_decimal_to_int_fail91);
    tcase_add_test(tc, test_from_decimal_to_int_fail92);
    tcase_add_test(tc, test_from_decimal_to_int_fail93);
    tcase_add_test(tc, test_from_decimal_to_int_fail94);
    tcase_add_test(tc, test_from_decimal_to_int_fail95);
    tcase_add_test(tc, test_from_decimal_to_int_fail96);
    tcase_add_test(tc, test_from_decimal_to_int_fail97);
    tcase_add_test(tc, test_from_decimal_to_int_fail98);
    tcase_add_test(tc, test_from_decimal_to_int_fail99);
    tcase_add_test(tc, test_from_decimal_to_int_fail100);
    tcase_add_test(tc, test_from_decimal_to_int_fail101);
    tcase_add_test(tc, test_from_decimal_to_int_fail102);
    tcase_add_test(tc, test_from_decimal_to_int_fail103);
    tcase_add_test(tc, test_from_decimal_to_int_fail104);
    tcase_add_test(tc, test_from_decimal_to_int_fail105);
    tcase_add_test(tc, test_from_decimal_to_int_fail106);
    tcase_add_test(tc, test_from_decimal_to_int_fail107);
    tcase_add_test(tc, test_from_decimal_to_int_fail108);
    tcase_add_test(tc, test_from_decimal_to_int_fail109);
    tcase_add_test(tc, test_from_decimal_to_int_fail110);
    tcase_add_test(tc, test_from_decimal_to_int_fail111);
    tcase_add_test(tc, test_from_decimal_to_int_fail112);
    tcase_add_test(tc, test_from_decimal_to_int_fail113);
    tcase_add_test(tc, test_from_decimal_to_int_fail114);
    tcase_add_test(tc, test_from_decimal_to_int_fail115);
    tcase_add_test(tc, test_from_decimal_to_int_fail116);
    tcase_add_test(tc, test_from_decimal_to_int_fail117);
    tcase_add_test(tc, test_from_decimal_to_int_fail118);
    tcase_add_test(tc, test_from_decimal_to_int_fail119);
    tcase_add_test(tc, test_from_decimal_to_int_fail120);
    tcase_add_test(tc, test_from_decimal_to_int_fail121);
    tcase_add_test(tc, test_from_decimal_to_int_fail122);
    tcase_add_test(tc, test_from_decimal_to_int_fail123);
    tcase_add_test(tc, test_from_decimal_to_int_fail124);
    tcase_add_test(tc, test_from_decimal_to_int_fail125);
    tcase_add_test(tc, test_from_decimal_to_int_fail126);
    tcase_add_test(tc, test_from_decimal_to_int_fail127);
    tcase_add_test(tc, test_from_decimal_to_int_fail128);
    tcase_add_test(tc, test_from_decimal_to_int_fail129);
    tcase_add_test(tc, test_from_decimal_to_int_fail130);
    tcase_add_test(tc, test_from_decimal_to_int_fail131);
    tcase_add_test(tc, test_from_decimal_to_int_fail132);
    tcase_add_test(tc, test_from_decimal_to_int_fail133);
    tcase_add_test(tc, test_from_decimal_to_int_fail134);
    tcase_add_test(tc, test_from_decimal_to_int_fail135);
    tcase_add_test(tc, test_from_decimal_to_int_fail136);
    tcase_add_test(tc, test_from_decimal_to_int_fail137);
    tcase_add_test(tc, test_from_decimal_to_int_fail138);
    tcase_add_test(tc, test_from_decimal_to_int_fail139);
    tcase_add_test(tc, test_from_decimal_to_int_fail140);
    tcase_add_test(tc, test_from_decimal_to_int_fail141);
    tcase_add_test(tc, test_from_decimal_to_int_fail142);
    tcase_add_test(tc, test_from_decimal_to_int_fail143);
    tcase_add_test(tc, test_from_decimal_to_int_fail144);
    tcase_add_test(tc, test_from_decimal_to_int_fail145);
    tcase_add_test(tc, test_from_decimal_to_int_fail146);
    tcase_add_test(tc, test_from_decimal_to_int_fail147);
    tcase_add_test(tc, test_from_decimal_to_int_fail148);
    tcase_add_test(tc, test_from_decimal_to_int_fail149);
    tcase_add_test(tc, test_from_decimal_to_int_fail150);
    tcase_add_test(tc, test_from_decimal_to_int_fail151);
    tcase_add_test(tc, test_from_decimal_to_int_fail152);
    tcase_add_test(tc, test_from_decimal_to_int_fail153);
    tcase_add_test(tc, test_from_decimal_to_int_fail154);
    tcase_add_test(tc, test_from_decimal_to_int_fail155);
    tcase_add_test(tc, test_from_decimal_to_int_fail156);
    tcase_add_test(tc, test_from_decimal_to_int_fail157);
    tcase_add_test(tc, test_from_decimal_to_int_fail158);
    tcase_add_test(tc, test_from_decimal_to_int_fail159);
    tcase_add_test(tc, test_from_decimal_to_int_fail160);
    tcase_add_test(tc, test_from_decimal_to_int_fail161);
    tcase_add_test(tc, test_from_decimal_to_int_fail162);
    tcase_add_test(tc, test_from_decimal_to_int_fail163);
    tcase_add_test(tc, test_from_decimal_to_int_fail164);
    tcase_add_test(tc, test_from_decimal_to_int_fail165);
    tcase_add_test(tc, test_from_decimal_to_int_fail166);
    tcase_add_test(tc, test_from_decimal_to_int_fail167);
    tcase_add_test(tc, test_from_decimal_to_int_fail168);
    tcase_add_test(tc, test_from_decimal_to_int_fail169);
    tcase_add_test(tc, test_from_decimal_to_int_fail170);
    tcase_add_test(tc, test_from_decimal_to_int_fail171);
    tcase_add_test(tc, test_from_decimal_to_int_fail172);
    tcase_add_test(tc, test_from_decimal_to_int_fail173);
    tcase_add_test(tc, test_from_decimal_to_int_fail174);
    tcase_add_test(tc, test_from_decimal_to_int_fail175);
    tcase_add_test(tc, test_from_decimal_to_int_fail176);
    tcase_add_test(tc, test_from_decimal_to_int_fail177);
    tcase_add_test(tc, test_from_decimal_to_int_fail178);
    tcase_add_test(tc, test_from_decimal_to_int_fail179);
    tcase_add_test(tc, test_from_decimal_to_int_fail180);
    tcase_add_test(tc, test_from_decimal_to_int_fail181);
    tcase_add_test(tc, test_from_decimal_to_int_fail182);
    tcase_add_test(tc, test_from_decimal_to_int_fail183);
    tcase_add_test(tc, test_from_decimal_to_int_fail184);
    tcase_add_test(tc, test_from_decimal_to_int_fail185);
    tcase_add_test(tc, test_from_decimal_to_int_fail186);
    tcase_add_test(tc, test_from_decimal_to_int_fail187);
    tcase_add_test(tc, test_from_decimal_to_int_fail188);
    tcase_add_test(tc, test_from_decimal_to_int_fail189);
    tcase_add_test(tc, test_from_decimal_to_int_fail190);
    tcase_add_test(tc, test_from_decimal_to_int_fail191);
    tcase_add_test(tc, test_from_decimal_to_int_fail192);
    tcase_add_test(tc, test_from_decimal_to_int_fail193);
    tcase_add_test(tc, test_from_decimal_to_int_fail194);
    tcase_add_test(tc, test_from_decimal_to_int_fail195);
    tcase_add_test(tc, test_from_decimal_to_int_fail196);
    tcase_add_test(tc, test_from_decimal_to_int_fail197);
    tcase_add_test(tc, test_from_decimal_to_int_fail198);
    tcase_add_test(tc, test_from_decimal_to_int_fail199);
    tcase_add_test(tc, test_from_decimal_to_int_fail200);
    tcase_add_test(tc, test_from_decimal_to_int_fail201);
    tcase_add_test(tc, test_from_decimal_to_int_fail202);
    tcase_add_test(tc, test_from_decimal_to_int_fail203);
    tcase_add_test(tc, test_from_decimal_to_int_fail204);
    tcase_add_test(tc, test_from_decimal_to_int_fail205);
    tcase_add_test(tc, test_from_decimal_to_int_fail206);
    tcase_add_test(tc, test_from_decimal_to_int_fail207);
    tcase_add_test(tc, test_from_decimal_to_int_fail208);
    tcase_add_test(tc, test_from_decimal_to_int_fail209);
    tcase_add_test(tc, test_from_decimal_to_int_fail210);
    tcase_add_test(tc, test_from_decimal_to_int_fail211);
    tcase_add_test(tc, test_from_decimal_to_int_fail212);
    tcase_add_test(tc, test_from_decimal_to_int_fail213);
    tcase_add_test(tc, test_from_decimal_to_int_fail214);
    tcase_add_test(tc, test_from_decimal_to_int_fail215);
    tcase_add_test(tc, test_from_decimal_to_int_fail216);
    tcase_add_test(tc, test_from_decimal_to_int_fail217);
    tcase_add_test(tc, test_from_decimal_to_int_fail218);
    tcase_add_test(tc, test_from_decimal_to_int_fail219);
    tcase_add_test(tc, test_from_decimal_to_int_fail220);
    tcase_add_test(tc, test_from_decimal_to_int_fail221);
    tcase_add_test(tc, test_from_decimal_to_int_fail222);
    tcase_add_test(tc, test_from_decimal_to_int_fail223);
    tcase_add_test(tc, test_from_decimal_to_int_fail224);
    tcase_add_test(tc, test_from_decimal_to_int_fail225);
    tcase_add_test(tc, test_from_decimal_to_int_fail226);
    tcase_add_test(tc, test_from_decimal_to_int_fail227);
    tcase_add_test(tc, test_from_decimal_to_int_fail228);
    tcase_add_test(tc, test_from_decimal_to_int_fail229);
    tcase_add_test(tc, test_from_decimal_to_int_fail230);
    tcase_add_test(tc, test_from_decimal_to_int_fail231);
    tcase_add_test(tc, test_from_decimal_to_int_fail232);
    tcase_add_test(tc, test_from_decimal_to_int_fail233);
    tcase_add_test(tc, test_from_decimal_to_int_fail234);
    tcase_add_test(tc, test_from_decimal_to_int_fail235);
    tcase_add_test(tc, test_from_decimal_to_int_fail236);
    tcase_add_test(tc, test_from_decimal_to_int_fail237);
    tcase_add_test(tc, test_from_decimal_to_int_fail238);
    tcase_add_test(tc, test_from_decimal_to_int_fail239);
    tcase_add_test(tc, test_from_decimal_to_int_fail240);
    tcase_add_test(tc, test_from_decimal_to_int_fail241);
    tcase_add_test(tc, test_from_decimal_to_int_fail242);
    tcase_add_test(tc, test_from_decimal_to_int_fail243);
    tcase_add_test(tc, test_from_decimal_to_int_fail244);
    tcase_add_test(tc, test_from_decimal_to_int_fail245);
    tcase_add_test(tc, test_from_decimal_to_int_fail246);
    tcase_add_test(tc, test_from_decimal_to_int_fail247);
    tcase_add_test(tc, test_from_decimal_to_int_fail248);
    tcase_add_test(tc, test_from_decimal_to_int_fail249);
    tcase_add_test(tc, test_from_decimal_to_int_fail250);
    tcase_add_test(tc, test_from_decimal_to_int_fail251);
    tcase_add_test(tc, test_from_decimal_to_int_fail252);
    tcase_add_test(tc, test_from_decimal_to_int_fail253);
    tcase_add_test(tc, test_from_decimal_to_int_fail254);
    tcase_add_test(tc, test_from_decimal_to_int_fail255);
    tcase_add_test(tc, test_from_decimal_to_int_fail256);
    tcase_add_test(tc, test_from_decimal_to_int_fail257);
    tcase_add_test(tc, test_from_decimal_to_int_fail258);
    tcase_add_test(tc, test_from_decimal_to_int_fail259);
    tcase_add_test(tc, test_from_decimal_to_int_fail260);
    tcase_add_test(tc, test_from_decimal_to_int_fail261);
    tcase_add_test(tc, test_from_decimal_to_int_fail262);
    tcase_add_test(tc, test_from_decimal_to_int_fail263);
    tcase_add_test(tc, test_from_decimal_to_int_fail264);
    tcase_add_test(tc, test_from_decimal_to_int_fail265);
    tcase_add_test(tc, test_from_decimal_to_int_fail266);
    tcase_add_test(tc, test_from_decimal_to_int_fail267);
    tcase_add_test(tc, test_from_decimal_to_int_fail268);
    tcase_add_test(tc, test_from_decimal_to_int_fail269);
    tcase_add_test(tc, test_from_decimal_to_int_fail270);
    tcase_add_test(tc, test_from_decimal_to_int_fail271);
    tcase_add_test(tc, test_from_decimal_to_int_fail272);
    tcase_add_test(tc, test_from_decimal_to_int_fail273);
    tcase_add_test(tc, test_from_decimal_to_int_fail274);
    tcase_add_test(tc, test_from_decimal_to_int_fail275);
